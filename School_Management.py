...
API TOOL:POSTMEN
Team Size:4
Name of institute: Quality Thought
=================================
...
Create the database name as sms_777 in side the MYSQL database

import dj_database_url

DATABASES['default'] = dj_database_url.parse('mysql://root@localhost/Python_100_Batch')
